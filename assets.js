...
function getLocalAssets() {
	return {
		...
		items: [
			// Stamina
			{ name: "Light Stamina Potion", stamina: 0.15, battle: true, craft: ['Empty Bottle', 'Green Herb'], id: '🧪' },
			{ name: "Medium Stamina Potion", stamina: 0.3, battle: true, craft: ['Empty Bottle', 'Green Herb', 'Blue Herb'], id: '🧪' },
			{ name: "Heavy Stamina Potion", stamina: 0.5, battle: true, craft: ['Reinforced Flask', 'Green Herb', 'Life Bloom'], id: '🧪' },
			{ name: "Great Stamina Potion", stamina: 0.7, battle: true, craft: ['Reinforced Flask', 'Mana Bloom', 'Green Herb', 'Mana Shard'], id: '🧪' },
			{ name: "Grand Stamina Potion", stamina: 0.9, battle: true, craft: ['Reinforced Flask', 'Mana Core', 'Life Bloom', 'Enchanting Powder'], id: '🧪' },

			// Health
			{ name: "Light Health Potion", health: 0.15, battle: true, craft: ['Empty Bottle', 'Red Herb'], id: '🧪' },
			{ name: "Medium Health Potion", health: 0.25, battle: true, craft: ['Empty Bottle', 'Red Herb', 'White Herb'], id: '🧪' },
			{ name: "Heavy Health Potion", health: 0.5, battle: true, craft: ['Reinforced Flask', 'Red Herb', 'Life Bloom', 'Purified Salt'], id: '🧪' },
			{ name: "Great Health Potion", health: 0.7, battle: true, craft: ['Reinforced Flask', 'Life Bloom', 'Purified Salt'], id: '🧪' },
			{ name: "Grand Health Potion", health: 0.9, battle: true, craft: ['Reinforced Flask', 'Mana Bloom', 'Life Bloom', 'Mana Core'], id: '🧪' },

			// Defense
			{ name: "Light Defense Potion", def: 0.15, rounds: 3, battle: true, craft: ['Empty Bottle', 'Black Herb'], id: '🧪' },
			{ name: "Medium Defense Potion", def: 0.3, rounds: 3, battle: true, craft: ['Empty Bottle', 'Black Herb', 'Yellow Herb'], id: '🧪' },
			{ name: "Heavy Defense Potion", def: 0.5, rounds: 3, battle: true, craft: ['Reinforced Flask', 'Black Herb', 'Life Bloom'], id: '🧪' },
			{ name: "Great Defense Potion", def: 0.7, rounds: 3, battle: true, craft: ['Reinforced Flask', 'Life Bloom', 'Purified Salt'], id: '🧪' },
			{ name: "Grand Defense Potion", def: 0.9, rounds: 3, battle: true, craft: ['Reinforced Flask', 'Mana Core', 'Life Bloom', 'Enchanting Powder'], id: '🧪' },

			// Attack
			{ name: "Light Attack Potion", buff: 0.15, rounds: 3, battle: true, craft: ['Empty Bottle', 'Blue Herb'], id: '🧪' },
			{ name: "Medium Attack Potion", buff: 0.3, rounds: 3, battle: true, craft: ['Empty Bottle', 'Blue Herb', 'Crimson Bloom'], id: '🧪' },
			{ name: "Heavy Attack Potion", buff: 0.5, rounds: 3, battle: true, craft: ['Reinforced Flask', 'Blue Herb', 'Ember Core', 'Blaze Powder'], id: '🧪' },
			{ name: "Great Attack Potion", buff: 0.7, rounds: 3, battle: true, craft: ['Reinforced Flask', 'Crimson Bloom', 'Ember Core'], id: '🧪' },
			{ name: "Grand Attack Potion", buff: 0.9, rounds: 3, battle: true, craft: ['Reinforced Flask', 'Mana Bloom', 'Ember Core', 'Enchanting Powder'], id: '🧪' },

			// Energy
			{ name: "Light Energy Potion", health: 0.15, stamina: 0.15, battle: true, craft: ['Empty Bottle', 'Green Herb', 'Red Herb'], id: '🧪' },
			{ name: "Medium Energy Potion", health: 0.15, stamina: 0.3, battle: true, craft: ['Empty Bottle', 'Green Herb', 'Red Herb', 'Blue Herb'], id: '🧪' },
			{ name: "Heavy Energy Potion", health: 0.15, stamina: 0.5, battle: true, craft: ['Reinforced Flask', 'Life Bloom', 'Green Herb'], id: '🧪' },
			{ name: "Great Energy Potion", health: 0.15, stamina: 0.7, battle: true, craft: ['Reinforced Flask', 'Mana Bloom', 'Life Bloom', 'Oceanshroom'], id: '🧪' },
			{ name: "Grand Energy Potion", health: 0.15, stamina: 0.9, battle: true, craft: ['Reinforced Flask', 'Mana Core', 'Life Bloom', 'Enchanting Powder'], id: '🧪' },

			// XP
			{ name: "Light XP Potion", xp: 638, craft: ['Mana Shard', 'Empty Bottle'], id: '🧪' },
			{ name: "Medium XP Potion", xp: 5740, craft: ['Mana Fragment', 'Empty Bottle'], id: '🧪' },
			{ name: "Heavy XP Potion", xp: 15943, craft: ['Mana Crystal', 'Empty Bottle'], id: '🧪' },
			{ name: "Great XP Potion", xp: 31250, craft: ['Mana Core', 'Empty Bottle'], id: '🧪' },
			{ name: "Grand XP Potion", xp: 51658, craft: ['Mana Core', 'Mana Bloom', 'Enchanting Powder'], id: '🧪' },

			// Misc consumables / foods
			{ name: "Purity Potion", craft: ['Purified Salt', 'Water Bottle', 'Angelic Rose'], id: '🧪' },
			...
			{ name: "Bandage", usability: "Removes [🩸]", description: "Patch yourself up.", health: 0.1, battle: true, craft: ['Cloth', 'Purified Salt'], id: '✨' },

			// Bombs / explosives
			{ name: "Bomb", battle: true, craft: ['Gunpowder', 'Stone'], id: '💣' },
			{ name: "Cluster Bomb", battle: true, craft: ['Bomb', 'Packed Gunpowder', 'Gunpowder', 'Slime Goop', 'Slime Fragment'], id: '💣' },
			{ name: "Blaze Bomb", battle: true, craft: ['Bomb', 'Blaze Powder', 'Ember Core'], id: '💣' },
			{ name: "Shrapnel Bomb", battle: true, craft: ['Bomb', 'Stone', 'Cloth', 'Blinding Powder', 'Slime Fragment'], id: '💣' },
			{ name: "Poison Bomb", estatus: ["💀"], battle: true, craft: ['Bomb', 'Poison Powder', 'Tainted Ashes', 'Goblin Blood', 'Tainted Rose'], id: '💣' },
			{ name: "Blinding Bomb", battle: true, craft: ['Bomb', 'Blinding Powder', 'Purified Salt'], id: '💣' },
			{ name: "Sinister Bomb", battle: true, craft: ['Bomb', 'Corrupted Shard', 'Corrupted Goop', 'Goblin Blood', 'Corrupted Core'], id: '💣' },
			{ name: "Storm Bomb", battle: true, craft: ['Bomb', 'Stormshroom', 'Packed Gunpowder'], id: '💣' },
			{ name: "Decay Bomb", battle: true, craft: ['Bomb', 'Tainted Ashes', 'Corrupted Fragment', 'Tainted Rose', 'Corrupted Crystal'], id: '💣' },
			{ name: "Unstable Bomb", battle: true, craft: ['Bomb', 'Packed Gunpowder', 'Tainted Ashes', 'Corrupted Crystal'], id: '💣' },
			{ name: "Unstable Cluster Bomb", battle: true, craft: ['Unstable Bomb', 'Packed Gunpowder', 'Bomb', 'Corrupted Core'], id: '💣' },
			{ name: "Unstable Shrapnel Bomb", battle: true, craft: ['Unstable Bomb', 'Shrapnel Bomb', 'Stone', 'Corrupted Fragment'], id: '💣' },

			// Charms / utility
			{ name: "Boss Lure", craft: ['Map Fragment', 'Lucky Rabbit Foot', 'Angelic Rose'], id: '✨' },
			{ name: "Monster Compass", craft: ['Map Fragment', 'Stone', 'Cloth'], id: '✨' },
			{ name: "Treasure Map", craft: ['Map Fragment', 'Enchanting Powder'], id: '✨' },
			{ name: "B-Gone", battle: true, craft: ['Lucky Rabbit Foot', 'Reinforced Flask'], id: '✨' },
			{ name: "A-Frayed", battle: true, craft: ['White Herb', 'Black Herb', 'Empty Bottle'], id: '✨' },
			{ name: "Loot Charm", craft: ['Lucky Rabbit Foot', 'Enchanting Powder'], id: '✨' },
			{ name: "Soul Charm", craft: ['Soul Fragment', 'Enchanting Powder'], id: '✨' },
			{ name: "Spirit Charm", craft: ['Mana Bloom', 'Soul Fragment', 'Slime Crystal'], id: '✨' },
			{ name: "Focus Charm", craft: ['Mana Shard', 'Enchanting Powder'], id: '✨' },
			...
			{ name: "Whetstone & Polish", craft: ['Whetstone', 'Cloth'], id: '✨' },
			{ name: "Hexed Whetstone & Polish", craft: ['Whetstone & Polish', 'Corrupted Shard'], id: '✨' },
