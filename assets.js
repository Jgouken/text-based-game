...
function getLocalAssets() {
	return {
		...
		items: [
			// Stamina
			{ name: "Light Stamina Potion", stamina: 0.15, battle: true, craft: ['Water Bottle', 'Goop', 'Yellow Herb'], id: '🧪' },
			{ name: "Medium Stamina Potion", stamina: 0.3, battle: true, craft: ['Light Stamina Potion', 'Stormshroom', 'Yellow Herb'], id: '🧪' },
			{ name: "Heavy Stamina Potion", stamina: 0.5, battle: true, craft: ['Reinforced Flask', 'Medium Stamina Potion', 'Slime Fragment', 'Yellow Herb'], id: '🧪' },
			{ name: "Great Stamina Potion", stamina: 0.7, battle: true, craft: ['Heavy Stamina Potion', 'Mana Crystal', 'Yellow Herb'], id: '🧪' },
			{ name: "Grand Stamina Potion", stamina: 1, battle: true, craft: ['Great Stamina Potion', 'Angelic Rose', 'Slime Geode', 'Yellow Herb', 'Enchanting Powder'], id: '🧪' },

			// Health
			{ name: "Light Health Potion", health: 0.15, battle: true, craft: ['Water Bottle', 'Goop', 'Green Herb'], id: '🧪' },
			{ name: "Medium Health Potion", health: 0.3, battle: true, craft: ['Light Health Potion', 'Life Bloom', 'Green Herb'], id: '🧪' },
			{ name: "Heavy Health Potion", health: 0.5, battle: true, craft: ['Reinforced Flask', 'Medium Health Potion', 'Slime Fragment', 'Mana Shard', 'Green Herb'], id: '🧪' },
			{ name: "Great Health Potion", health: 0.7, battle: true, craft: ['Heavy Health Potion', 'Mana Fragment', 'Mana Bloom', 'Green Herb'], id: '🧪' },
			{ name: "Grand Health Potion", health: 1, battle: true, craft: ['Great Health Potion', 'Slime Geode', 'Angelic Rose', 'Green Herb', 'Enchanting Powder'], id: '🧪' },

			// Defense
			{ name: "Light Defense Potion", def: 0.15, rounds: 3, battle: true, craft: ['Water Bottle', 'Goop', 'Blue Herb'], id: '🧪' },
			{ name: "Medium Defense Potion", def: 0.3, rounds: 3, battle: true, craft: ['Light Defense Potion', 'Stormshroom', 'Blue Herb'], id: '🧪' },
			{ name: "Heavy Defense Potion", def: 0.5, rounds: 3, battle: true, craft: ['Reinforced Flask', 'Medium Defense Potion', 'Mana Shard', 'Slime Fragment', 'Blue Herb'], id: '🧪' },
			{ name: "Great Defense Potion", def: 0.7, rounds: 3, battle: true, craft: ['Heavy Defense Potion', 'Mana Bloom', 'Blue Herb', 'Purified Salt'], id: '🧪' },
			{ name: "Grand Defense Potion", def: 1, rounds: 3, battle: true, craft: ['Great Defense Potion', 'Angelic Rose', 'Mana Core', 'Mana Crystal', 'Blue Herb', 'Enchanting Powder'], id: '🧪' },

			// Attack
			{ name: "Light Attack Potion", buff: 0.15, rounds: 3, battle: true, craft: ['Water Bottle', 'Goop', 'Red Herb'], id: '🧪' },
			{ name: "Medium Attack Potion", buff: 0.3, rounds: 3, battle: true, craft: ['Light Attack Potion', 'Crimson Bloom'], id: '🧪' },
			{ name: "Heavy Attack Potion", buff: 0.5, rounds: 3, battle: true, craft: ['Reinforced Flask', 'Medium Attack Potion', 'Blaze Powder', 'Slime Fragment'], id: '🧪' },
			{ name: "Great Attack Potion", buff: 0.7, rounds: 3, battle: true, craft: ['Heavy Attack Potion', 'Ember Core', 'Mana Fragment'], id: '🧪' },
			{ name: "Grand Attack Potion", buff: 1, rounds: 3, battle: true, craft: ['Great Attack Potion', 'Tainted Rose', 'Mana Core', 'Goblin Blood', 'Enchanting Powder'], id: '🧪' },

			// Energy
			{ name: "Light Energy Potion", health: 0.05, stamina: 0.1, battle: true, craft: ['Water Bottle', 'Green Herb', 'Yellow Herb', 'Goop'], id: '🧪' },
			{ name: "Medium Energy Potion", health: 0.15, stamina: 0.25, battle: true, craft: ['Light Energy Potion', 'Green Herb', 'Yellow Herb', 'White Herb'], id: '🧪' },
			{ name: "Heavy Energy Potion", health: 0.25, stamina: 0.33, battle: true, craft: ['Reinforced Flask', 'Medium Energy Potion', 'Life Bloom', 'Mana Fragment', 'Slime Fragment'], id: '🧪' },
			{ name: "Great Energy Potion", health: 0.35, stamina: 0.5, battle: true, craft: ['Heavy Energy Potion', 'Mana Bloom', 'Green Herb', 'Yellow Herb'], id: '🧪' },
			{ name: "Grand Energy Potion", health: 1, stamina: 1, battle: true, craft: ['Great Energy Potion', 'Mana Core', 'Slime Geode', 'Angelic Rose', 'Green Herb', 'Enchanting Powder'], id: '🧪' },

			// XP
			{ name: "Light XP Potion", xp: 638, craft: ['Mana Shard', 'Water Bottle', 'Goop', 'White Herb'], id: '🧪' },
			{ name: "Medium XP Potion", xp: 5740, craft: ['Light XP Potion', 'Mana Bloom', 'Mana Fragment', 'White Herb'], id: '🧪' },
			{ name: "Heavy XP Potion", xp: 15943, craft: ['Medium XP Potion', 'Mana Crystal', 'Slime Fragment', 'White Herb'], id: '🧪' },
			{ name: "Great XP Potion", xp: 31250, craft: ['Heavy XP Potion', 'Mana Core', 'Slime Crystal', 'White Herb'], id: '🧪' },
			{ name: "Grand XP Potion", xp: 51658, craft: ['Great XP Potion', 'Angelic Rose', 'Slime Geode', 'White Herb', 'Enchanting Powder'], id: '🧪' },

			// Misc consumables / foods
			{ name: "Purity Potion", purify: true, craft: ['Water Bottle', 'Purified Salt', 'Enchanting Powder'], id: '🧪' },
			...
			{ name: "Bandage", usability: "Removes [🩸]", description: "Patch yourself up.", health: 0.1, battle: true, craft: ['Cloth', 'Green Herb'], id: '✨' },

			// Bombs / explosives
			{ name: "Bomb", damage: 420, battle: true, craft: ['Gunpowder', 'Iron'], id: '💣' },
			{ name: "Cluster Bomb", damage: 120, times: 6, battle: true, craft: ['Bomb', 'Bomb', 'Packed Gunpowder'], id: '💣' },
			{ name: "Blaze Bomb", damage: 500, estatus: ["🔥"], battle: true, craft: ['Bomb', 'Blaze Powder', 'Ember Core'], id: '💣' },
			{ name: "Shrapnel Bomb", damage: 50, times: 12, battle: true, craft: ['Bomb', 'Gunpowder', 'Iron', 'Empty Bottle'], id: '💣' },
			{ name: "Poison Bomb", damage: 200, estatus: ["💀"], battle: true, craft: ['Bomb', 'Poison Powder', 'Enchanting Powder'], id: '💣' },
			...
			{ name: "Mana Crystal", craft: ['Mana Fragment', 'Mana Fragment'] },
			{ name: "Mana Core", craft: ['Mana Crystal', 'Mana Crystal'] },
			{ name: "Goblin Blood" },
			...
			{ name: "Crimson Bloom", craft: ['Red Herb', 'Mana Bloom'] },
			...
			{ name: "Wool" },
			{ name: "Cloth", craft: ['Wool', 'Wool'] },
			{ name: "Empty Bottle", craft: ['Water Bottle'] },
			{ name: "Water Bottle", craft: ['Empty Bottle'] },
			{ name: "Map Fragment" },
			{ name: "Soul Fragment" },
